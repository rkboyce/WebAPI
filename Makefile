...
test-public:
	wget -O tests/test-general-evidence.json "http://api.ohdsi.org/WebAPI/CS1/evidence/752061"
	wget -O tests/test-drug-hoi.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/752061-374013"
	wget -O tests/test-drug.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drug/752061"
	wget -O tests/test-hoi.json "http://api.ohdsi.org/WebAPI/CS1/evidence/hoi/320073"
	wget -O tests/test-info.json "http://api.ohdsi.org/WebAPI/CS1/evidence/info"
	wget -O tests/test-drug-hoi-eu-spc.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/904351-4190045" 
	wget -O tests/test-drug-hoi-splicer.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/19133853-195588"
	wget -O tests/test-drug-hoi-faers-counts-and-signals.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/1154343-433031"
	wget -O tests/test-drug-hoi-pubmed-mesh-cr.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/1154343-433031" 
	wget -O tests/test-drug-hoi-pubmed-mesh-clin-trial.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/789578-378144"
	wget -O tests/test-drug-hoi-pubmed-mesh-other.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/19010482-316866"
	wget -O tests/test-drug-hoi-semmed-cr.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/1112807-441202"
	wget -O tests/test-drug-hoi-semmed-clin-trial.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drughoi/19059744-381591"
	wget -O tests/test-drug-rollup-ingredient.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drugrollup/ingredient/1000632"
	wget -O tests/test-drug-rollup-clin-drug.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drugrollup/clinicaldrug/19074181"
	wget -O tests/test-drug-rollup-branded-drug.json "http://api.ohdsi.org/WebAPI/CS1/evidence/drugrollup/brandeddrug/1000640"
	wget -O tests/test-rdf-evidencesummary.json "http://api.ohdsi.org/WebAPI/CS1/evidence/evidencesummary?conditionID=139900&drugID=1115008&evidenceGroup=Literature"
	wget -O tests/test-rdf-evidencedetails.json "http://api.ohdsi.org/WebAPI/CS1/evidence/evidencedetails?conditionID=24134&drugID=1115008&evidenceType=SPL_SPLICER_ADR"
